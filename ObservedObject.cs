...
namespace EphemSharp
{
    public class ObservedObject
    {
        ...
        public ObservedObject(Angle altitude, Angle azimuth, Angle hourAnge, Distance distance = null)
        {
            HourAngle = hourAnge;
            Altitude = altitude;
            Azimuth = azimuth;
        ...
        public ObservedObject(Angle altitude, Angle azimuth, Angle hourAnge, Angle rightAscension, Angle declination, Distance distance = null)
        {
            HourAngle = hourAnge;
            Altitude = altitude;
            Azimuth = azimuth;
